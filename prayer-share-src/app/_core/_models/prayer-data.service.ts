...
export class PrayerDataService {
  private readonly _cards$ = new BehaviorSubject<PrayerCard[]>([
    {
      id: 1,
      title: 'CJ — Tech School & Finances',
      detail: 'Wisdom, steady work, and provision.',
      category: 'Family',
      createdAt: new Date().toISOString(),
      comments: [
        { commentID: 1, author: 'Courtney', text: 'Interview this Friday.', createdAt: new Date().toISOString() }
      ]
    },
    {
      id: 2,
      title: 'AI Workshops — Reach CEOs',
      detail: 'Clarity, helpful connections, God's favor.',
      category: 'Work',
      createdAt: new Date().toISOString(),
      comments: [
        { commentID: 2, author: 'Courtney', text: 'Scheduling Oct 2 session.', createdAt: new Date().toISOString() }
      ]
    }
  ]);
